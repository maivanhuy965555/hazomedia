...
class WP_bootstrap_4_walker_nav_menu extends Walker_Nav_menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if( $args->walker->has_children && $depth == 0 ) {
            $dropdown_class = 'dropdown cus-dropdown';
            $dropdown_link_class = 'dropdown-toggle';
        }

        $output .= "<li class='nav-item line-center $active_class $dropdown_class " .  implode(" ", $item->classes) . "'>";
    ...
    function start_lvl( &$output, $depth=0, $args = array() ){
        ...
        $output .= "<ul class='dropdown-menu cus-dropdown-menu $submenu depth_$depth'>";
    }
